...
public class LP-Atividade-01-02-2040482612046{
    public static void main(String[] args) {
        ...
        System.out.println("Dentro do Cache (" + valorCache
                + ") -> xCache == yCache: " + (xCache == yCache));

        System.out.println("Fora do Cache (" + valorForaCache
                + ") -> xForaCache == yForaCache: " + (xForaCache == yForaCache));
